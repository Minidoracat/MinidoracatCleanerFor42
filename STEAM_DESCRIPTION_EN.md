...
[*] [b]Automatic floor item cleanup[/b]: two independent thresholds — a [u]per-chunk[/u] (8×8 tiles) limit for concentrated dumping and a [u]total area[/u] limit for spread-out piles
...
[list]
[*] 100 same-type floor items per chunk, 400 across the scan area
